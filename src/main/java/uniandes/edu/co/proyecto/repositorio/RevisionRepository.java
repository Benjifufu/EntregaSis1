...
public interface RevisionRepository extends JpaRepository<Revision, Long> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO Revision (IDREVISION, CALIFICACION, COMENTARIO, REVISIONSERVICIOUSUARIO, IDUSUARIOCLIENTE, IDUSUARIOCONDUCTOR) VALUES (REVISION_SEQ.nextval, :CALIFICACION, :COMENTARIO, :REVISIONSERVICIOUSUARIO, :IDUSUARIOCLIENTE, :IDUSUARIOCONDUCTOR)", nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE Revision SET CALIFICACION=:CALIFICACION, COMENTARIO=:COMENTARIO, REVISIONSERVICIOUSUARIO=:REVISIONSERVICIOUSUARIO, IDUSUARIOCLIENTE=:IDUSUARIOCLIENTE, IDUSUARIOCONDUCTOR=:IDUSUARIOCONDUCTOR WHERE IDREVISION=:IDREVISION", nativeQuery = true)
